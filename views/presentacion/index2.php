...
/** @var app\models\PresentacionSearch $searchModel */
...
<?php endif; ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'format' => 'raw',
            'value' => function ($model) {
                return Html::a('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Acta', ['view-pdf', 'id' => $model->idPresentacion], ['class' => 'btn secondary', 'style' => 'color: inherit']); // Utiliza 'color: inherit' para heredar el color de texto del padre (la fila)
            },
        ],
    ],
