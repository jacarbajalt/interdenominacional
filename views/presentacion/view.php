...
$this->title = $model->idPresentacion .' '. $model->Nombre_presentado .' '. $model->Apelli_Pat.' '. $model->Apellido_Mat;
...
<div class="presentacion-view" style="color: white;">

    <h2>Pequeño/a <?= Html::encode($this->title) ?></h2>

    <p>
   
        <button class="button"> <?= Html::a('<i class="fa fa-undo" aria-hidden="true"></i> Actualizar', ['update', 'idPresentacion' => $model->idPresentacion], ['class' => '']) ?></button> 
        
         <button class="fill"> <?= Html::a('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Generar Acta', ['view-pdf', 'id' => $model->idPresentacion], ['class' => '']) ?></button> 
